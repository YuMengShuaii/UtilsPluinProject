...
import com.enation.javashop.utils.base.dialog.MyDialog;
...
public abstract class UtilsActivity extends AppCompatActivity implements Utilsinterface {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!ScrollBackConfig.isOpenScrollBack()){
            scrollBackView.setEnableGesture(false);
        }else{
            if (getRunningActivityName().equals(ScrollBackConfig.getHomeName())){
                scrollBackView.setEnableGesture(false);
            }
        }
        initUtils();
